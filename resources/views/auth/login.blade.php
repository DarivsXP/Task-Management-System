        ...
        @if (Route::has('register'))
            <div class="mt-5 pt-5 border-t border-slate-200 text-center">
                ...
                <a href="{{ route('register') }}"
                    class="mt-2 inline-flex items-center justify-center w-full px-5 py-2.5 border-2 border-indigo-600 text-indigo-600 rounded-lg font-bold text-sm hover:bg-indigo-50 transition-all">
                    Create an Account
                </a>
            </div>
        @endif
